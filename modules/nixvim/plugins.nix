...
in
{
  config = lib.mkIf config.werapi.nixvim.enable {
        ...
        servers = {
          ...
          nixd = {
            ...
            settings = {
              ...
              options = {
                nixos.expr = "(builtins.getFlake (\"${hmConfig.home.homeDirectory}/nixos-config\")).nixosConfigurations.${config.system.name}.options";
              };
            };
          };
          qmlls.enable = true;
